...
- [authorization ] Explain what a token is used for.
- [use tokens ] What steps can you take in your web apps to keep your data secure?
- [processes network requests, stores and ddelievers web pages to client ] Describe how web servers work.
- [get,post,delete, put ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
